...
def get_co_workflow_seed_true_kb():
    """Workflow-aligned verified true KB seeds for live CO alarm verification."""
    now = datetime.utcnow().isoformat()
    return [
        {
            "kb_id": "co_seed_true_001",
            "tenant_id": None,
            "use_case": "co_alarm",
            "description": "Generic active CO alarm pattern: red light, loud repeating alarm, ongoing repeat, and caller believes it is a possible CO alarm.",
            "outcome": "emergency_dispatch",
            "tags": ["workflow_seed", "co_alarm", "red_light", "repeating_four_beep_pattern", "possible_co_alarm"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "Other / Cannot see",
                "model": "Unknown",
                "workflow_outcome": "emergency_dispatch",
                "pattern_fields": {
                    "alarm_type": "CO (Carbon Monoxide) alarm",
                    "light_pattern": "Red",
                    "sound_pattern": "4 quick beeps",
                    "state_now": "Alarm sounding now",
                    "repeat_pattern": "Keeps repeating",
                    "likely_meaning": "Possible CO alarm",
                },
                "derived_tags": ["red_light", "repeating_four_beep_pattern", "possible_co_alarm"],
            },
            "resolution_summary": "Workflow seed for strong CO alarm patterns requiring emergency response.",
        ...
        {
            "kb_id": "co_seed_true_002",
            "tenant_id": None,
            "use_case": "co_alarm",
            "description": "Kidde 2030-DCR pattern with red light, 4 quick beeps, active repeating alarm, and possible CO indication.",
            "outcome": "emergency_dispatch",
            "tags": ["workflow_seed", "kidde", "2030-dcr", "red_light", "possible_co_alarm"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "Kidde",
                "model": "2030-DCR",
            ...
            "resolution_summary": "Workflow-derived Kidde emergency CO pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_true_003",
            "tenant_id": None,
            "use_case": "co_alarm",
            "description": "Aico high-risk CO alarm pattern with red indication, active repeating alarm, and CO-like summary.",
            "outcome": "emergency_dispatch",
            "tags": ["workflow_seed", "aico", "possible_co_alarm", "red_light"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "Aico",
                "model": "Ei3030",
            ...
            "resolution_summary": "Workflow-derived Aico emergency CO pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_true_004",
            "tenant_id": None,
            "use_case": "co_alarm",
            "description": "FireAngel active red alarm pattern treated as a real CO incident.",
            "outcome": "emergency_dispatch",
            "tags": ["workflow_seed", "fireangel", "possible_co_alarm", "red_light"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "FireAngel",
                "model": "FA6813",
                "workflow_outcome": "emergency_dispatch",
                "pattern_fields": {
                    "light_pattern": "Red with sound",
                    "sound_pattern": "4 loud chirps",
                    "state_now": "Alarm sounding now",
                    "repeat_pattern": "Repeating alarm now",
                    "likely_meaning": "Possible CO alarm",
                },
                "derived_tags": ["red_light", "repeating_four_beep_pattern", "possible_co_alarm"],
            },
            "resolution_summary": "Workflow-derived FireAngel emergency CO pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_true_005",
            "tenant_id": None,
            "use_case": "co_alarm",
            "description": "X-Sense active red alarm pattern aligned to true incident verification.",
            "outcome": "emergency_dispatch",
            "tags": ["workflow_seed", "x-sense", "possible_co_alarm", "red_light"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "X-Sense",
                "model": "XC0C-IR",
                "workflow_outcome": "emergency_dispatch",
                "pattern_fields": {
                    "light_pattern": "Red flashing",
                    "sound_pattern": "4 loud beeps",
                    "state_now": "Alarm sounding now",
                    "repeat_pattern": "Keeps repeating",
                    "likely_meaning": "Possible CO alarm",
                },
            ...
            "resolution_summary": "Workflow-derived X-Sense emergency CO pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
...
def get_co_workflow_seed_false_kb():
    """Workflow-aligned verified false KB seeds for live CO alarm verification."""
    now = datetime.utcnow().isoformat()
    return [
        {
            "kb_id": "co_seed_false_001",
            "tenant_id": None,
            "reported_as": "co_alarm",
            "actual_issue": "Generic low battery or maintenance pattern on CO alarm",
            "false_positive_reason": "Yellow/amber or green indication with chirping and maintenance-style behaviour usually reflects battery, end-of-life, or non-emergency alarm state rather than a live CO incident.",
            "tags": ["workflow_seed", "co_alarm", "battery_issue", "end_of_life", "fault", "normal_pattern"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "Other / Cannot see",
                "model": "Unknown",
                ...
                "pattern_fields": {
                    "sound_pattern": "Single chirp",
                    "state_now": "Just chirping",
                    "repeat_pattern": "About every minute",
                    "likely_meaning": "Low battery",
                },
                "derived_tags": ["chirping", "battery_issue"],
            },
            "resolution": "Workflow seed for generic maintenance or battery/fault alarm patterns.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_false_002",
            "tenant_id": None,
            "reported_as": "co_alarm",
            "actual_issue": "Kidde end-of-life or maintenance chirp pattern",
            "false_positive_reason": "Green or non-alarm indication with warning chirps and end-of-life meaning is a classic false CO report pattern for Kidde alarms.",
            "tags": ["workflow_seed", "kidde", "battery_issue", "end_of_life", "chirping"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "Kidde",
                "model": "K5DCO",
                ...
                "pattern_fields": {
                    "light_pattern": "Green",
                    "sound_pattern": "2 warning chirps",
                    "state_now": "Just chirping",
                    "repeat_pattern": "Keeps repeating",
                    "likely_meaning": "End of life",
                },
                "derived_tags": ["chirping", "end_of_life", "green_light"],
            },
            "resolution": "Workflow-derived Kidde maintenance/end-of-life pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_false_003",
            "tenant_id": None,
            "reported_as": "co_alarm",
            "actual_issue": "Aico normal or non-CO standby pattern",
            "false_positive_reason": "Green flash with silence and normal summary does not indicate active CO on Aico workflow paths.",
            "tags": ["workflow_seed", "aico", "green_light", "normal_pattern"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "Aico",
                "model": "Ei3030",
                ...
                "pattern_fields": {
                    "light_pattern": "Green",
                    "sound_pattern": "Silent",
                    "state_now": "Normal",
                    "repeat_pattern": "Normal",
                    "likely_meaning": "Normal",
                },
                "derived_tags": ["green_light", "silent", "normal_pattern"],
            },
            "resolution": "Workflow-derived Aico normal standby pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_false_004",
            "tenant_id": None,
            "reported_as": "co_alarm",
            "actual_issue": "FireAngel end-of-life / amber warning pattern",
            "false_positive_reason": "Amber flashes and warning chirps on FireAngel are maintenance-style patterns, not true CO alerts.",
            "tags": ["workflow_seed", "fireangel", "end_of_life", "battery_issue", "amber_or_yellow_light"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "FireAngel",
                "model": "FA6813",
                "workflow_outcome": "close_with_guidance",
                "pattern_fields": {
                    "light_pattern": "Amber 2 flashes / 40 sec",
                    "sound_pattern": "2 chirps / 40 sec",
                    "state_now": "Just a warning chirp",
                    "repeat_pattern": "Every 40 sec only",
                    "likely_meaning": "End of life",
                },
                "derived_tags": ["amber_or_yellow_light", "chirping", "end_of_life"],
            },
            "resolution": "Workflow-derived FireAngel maintenance/end-of-life pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_false_005",
            "tenant_id": None,
            "reported_as": "co_alarm",
            "actual_issue": "X-Sense standby/normal pattern",
            "false_positive_reason": "Green flash with silence and normal behaviour is aligned to a false report or no-active-CO pattern in the X-Sense workflow.",
            "tags": ["workflow_seed", "x-sense", "green_light", "normal_pattern", "silent"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "X-Sense",
                "model": "XC0C-IR",
                "workflow_outcome": "close_with_guidance",
                "pattern_fields": {
                    "light_pattern": "Green flash",
                    "sound_pattern": "Silent",
                    "state_now": "Normal",
                    "repeat_pattern": "Not sure",
                    "likely_meaning": "Normal",
                },
                "derived_tags": ["green_light", "silent", "normal_pattern"],
            },
            "resolution": "Workflow-derived X-Sense standby pattern.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
        ...
        {
            "kb_id": "co_seed_false_006",
            "tenant_id": None,
            "reported_as": "co_alarm",
            "actual_issue": "Smoke alarm or non-CO alarm confusion pattern",
            "false_positive_reason": "If the selected alarm type or matched pattern resembles smoke-only or non-CO warnings, the report is historically much more likely to be false for CO triage.",
            "tags": ["workflow_seed", "smoke_alarm", "misidentification", "false_alarm"],
            "incident_pattern": {
                "use_case": "co_alarm",
                "manufacturer": "Other / Cannot see",
                "model": "Unknown",
                ...
                "derived_tags": ["smoke_alarm", "normal_pattern"],
            },
            "resolution": "Workflow seed for smoke-alarm confusion patterns.",
            "source": "workflow_seed",
            "verified_by": "system",
            "verified_at": now,
            "created_at": now,
